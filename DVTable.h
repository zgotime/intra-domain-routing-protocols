...
public:
  ...
  void set_dv_packet(char* packet, unsigned short dst_id, hash_map<unsigned short, unsigned short>& routing_table);
  ...
  void print_dv(hash_map<unsigned short, unsigned short>& routing_table);
