...
struct equal_pair {
  bool operator()(const pr one, const pr two) {
...
class Simulator {
 ...
 private:
  ...
  hash_map<int, Node *> node_table;
  hash_map<int_pair, Link *, hash_pair, equal_pair> link_table;
  //end of pyuan

  //twngan added
  hash_map<const char *, int> protocol_table;
  //end of twngan
